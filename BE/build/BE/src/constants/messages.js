export const USER_NOT_FOUND = 'Користувач не знайден';
export const USER_PASSWORD_INVALID = 'Невірний пароль';
...
export const EP_REMOVAL_CANCELED = 'Навчальний план повернуто';
