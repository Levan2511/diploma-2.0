...
export function getTotalTermLabs(data) {
    const labs = {
        labs1: 0,
        labs2: 0,
        labs: 0,
...
export function getTotalTermPractical(data) {
    const practical = {
        practical1: 0,
        practical2: 0,
        practical: 0,
...
export function getTotalTermSelfWork(data) {
    return data.reduce((prev, curr) => {
        return prev + curr.selfWork;
    }, 0);
}
export function getTotalTermClassHours(data) {
    return data.reduce((prev, curr) => {
        return prev + curr.classHours;
    }, 0);
}
export function getTotalTermHours(data) {
    return data.reduce((prev, curr) => {
        return prev + curr.totalHours;
    }, 0);
}
export function getTotalTermCredits(data) {
    return data.reduce((prev, curr) => {
        return prev + curr.credits;
    }, 0);
}
export function getTotalTermRGR(data) {
    const RGRtypes = {
        RGR: 0,
        RR: 0,
        RK: 0,
...
export function getTotalTermExams(data) {
    const examTypes = {
        exam: 0,
        test: 0,
        test2: 0,
...
export function getTotalTerm(data) {
    return {
